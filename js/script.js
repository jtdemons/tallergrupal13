window.onload = function()
{
    ...
    nom_div("validaAdivina").addEventListener('click', function(event)
    {
        ...
        {
        	console.log("listo" + numeroAleatorio + numeroUsuario);
        	if (numeroUsuario <= 10 && numeroUsuario >= 1)
        	{
        		 if (numeroUsuario == numeroAleatorio)
        {
        	console.log("por fin");
        	 nom_div("mensajeAdivina").innerHTML = "ADIVINASTE EL NUMEROOOOooo..";
        } else{
        	nom_div("mensajeAdivina").innerHTML = "no has adivinado";
        }
          } else {
          	 nom_div("mensajeAdivina").innerHTML = " el numero debe ser menor ha 10 y mayor a 0 ";
          }
          
        	}else {
          	 nom_div("mensajeAdivina").innerHTML = " no ha generado numero aleatorio ";
          }
	...
	{
		var num = estudiantes.length;
		for(i<=estudiantes.length; i++){
